...
<div class="text-center">
  {% include figure.liquid loading="eager" path="assets/img/siemens/siemens_presentation_usual_way.jpeg" class="img-fluid rounded z-depth-1" max-width="900px" %}
</div>
<div class="text-center mt-3">
  {% include figure.liquid loading="eager" path="assets/img/siemens/siemens_presentation_smart_way.jpeg" class="img-fluid rounded z-depth-1" max-width="900px" %}
</div>
<div class="text-center mt-3">
  {% include figure.liquid loading="eager" path="assets/img/siemens/siemens_pic_1.jpeg" class="img-fluid rounded z-depth-1" max-width="900px" %}
</div>
<div class="text-center mt-3">
  {% include figure.liquid loading="eager" path="assets/img/siemens/siemens_pic_2.jpeg" class="img-fluid rounded z-depth-1" max-width="900px" %}
</div>
